...
public class CodeGenerator {
    ...
    public static void javaFileGenerate(Map<Button, MobileScreen> sceneMap) {
        ...
        while (buttonQueue.size() > 0) {
            ...
            fileCreator(start + component + onclick + end, "activity" + activityNumber, ".java",
                    Constants.PROJECT_PATH + File.separator + "apk" + File.separator + "src" + File.separator + "com" + File.separator + "AndroidFramework" + File.separator + Constants.PROJECT_NAME + File.separator);
            activityNumber++;
        }
    }
    ...
    public static void manifestGenerate(ArrayList<String> screenTitles, String appTheme, String icon) {
        ...
        fileCreator(customTheme, "style", ".xml", Constants.PROJECT_PATH + File.separator + "apk" + File.separator + "res" + File.separator + "values" + File.separator);
    ...
    public static void layoutGenerate(Map<Button, MobileScreen> sceneMap) {
        ...
        while (buttonQueue.size() > 0) {
            ...
            fileCreator(start + component + end, "activity" + activityNumber, ".xml",
                    Constants.PROJECT_PATH + File.separator + "apk" + File.separator + "res" + File.separator + "layout" + File.separator);
            activityNumber++;
        }
    }
    ...
    public static void resourceGenerate(Map<Button, MobileScreen> sceneMap) {
        ...
        fileCreator(start + component + end, "strings", ".xml", Constants.PROJECT_PATH + File.separator + "apk" + File.separator + "res" + File.separator + "values" + File.separator);
    }
    ...
    public static void generateAPK() {
        ...
        if (cmdResult.contains("BUILD SUCCESSFUL")) {
            JOptionPane.showMessageDialog(null,
                    "APK Generated Successfully\n\nAPK Path: " + Constants.PROJECT_PATH + File.separator + "apk"
                    + File.separator + "bin" + File.separator + Constants.PROJECT_NAME + "-debug.apk",
